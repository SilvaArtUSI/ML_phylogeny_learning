...
while (epoch < n_epochs & trigger < patience) {
  ...
  if (current_loss< best_loss){
    #save best model
    torch_save(cnn_ltt, paste("PLD_04_CNNLTT","lay",n_layer,"hid",n_hidden="-"))
    best_epoch<-epoch
...
torch_save(cnn_ltt, paste( "M04_CNNLTT-DDD-",subset_size,"Lay",n_layer,"Hn",n_hidden,"ker",ker_size,"p",patience,sep="-"))
cat(paste("\n Model cnn ltt saved", sep = ""))
cat("\nSaving model... Done.")

cnn_ltt<-torch_load( paste( "M04_CNNLTT-DDD-",subset_size,"Lay",n_layer,"Hn",n_hidden,"ker",ker_size,"p",patience,sep="-"))
...
cnn_ltt<-torch_load( paste( "M04_CNNLTT-DDD-K",k[1],k[2],subset_size,"Lay",n_layer,"Hn",n_hidden,"ker",ker_size,"p",patience,sep="-"))
