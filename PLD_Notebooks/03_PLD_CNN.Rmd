...
png("Plots/cnn_truevspred.png", width = width, height = height, units = "in", res = dpi)
...
plot(true[[3]][test_indices], pred[[3]] , main = "K", xlab = "True", ylab = "Predicted")
abline(0, 1,col="red")
plot(true[[4]][test_indices], pred[[4]] , main = "K", xlab = "True", ylab = "Predicted")
abline(0, 1,col="red")
```
