...
# Plot the loss curve
png("data_DDD/plots/loss_cnnlttcorr.png")
...
cnn_ltt_time<-print(end_time - start_time)
...
png("data_DDD/plots/hist_cnnlttcorr.png", width = 480*3*factor, height = 480*factor,res=dpi)
par(mfrow = c(1, 4))
...
abline(0, 1,col="red")
plot(beta , beta_pred , main = "Beta", xlab = "True", ylab ="Predicted",xlim=c(-.6,0.0))
abline(0, 1,col="red")
dev.off()
```
