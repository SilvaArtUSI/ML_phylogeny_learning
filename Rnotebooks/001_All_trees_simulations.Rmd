...
saveRDS(output_ddd$trees, paste("data_clas/phylogeny-DDD2", "-",phylo_name_ddd,".rds", sep=""))
saveRDS(output_ddd$param, paste("data_clas/true-param-DDD2", "-",phylo_name_ddd,".rds", sep=""))
saveRDS(output_ddd$brts, paste("data_clas/brts-DDD2-",phylo_name_ddd,".rds", sep=""))
