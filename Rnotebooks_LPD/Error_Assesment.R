...
#Plots
###CNN
png("data_PLD/plots/cnn_estimated_5002.png", width = 480*3*factor, height = 480*factor,res=dpi)
par(mfrow = c(1, 4))
...
abline(0, 1,col="red")
plot(true[[3]][test_indices] , nn.pred_cnn[[3]] , main = "beta N", xlab = "True", ylab = "Predicted")
abline(0, 1,col="red")
plot(true[[4]][test_indices]  ,  nn.pred_cnn[[4]] , main = "beta P", xlab = "True", ylab ="Predicted")
abline(0, 1,col="red")
dev.off()

#Plots
###CNNLTT
png("data_PLD/plots/cnnltt_estimated_5002.png", width = 480*3*factor, height = 480*factor,res=dpi)
par(mfrow = c(1, 4))
...
abline(0, 1,col="red")
plot(true[[3]][test_indices] , nn.pred_ltt[[3]] , main = "beta N", xlab = "True", ylab = "Predicted")
abline(0, 1,col="red")
plot(true[[4]][test_indices]  ,  nn.pred_ltt[[4]] , main = "beta P", xlab = "True", ylab ="Predicted")
abline(0, 1,col="red")
dev.off()
...
png("data_PLD/plots/violin_plotcnnltt2.png", width = 800, height = 300,res=125)
print(cnnltt_vio)
dev.off()

png("data_PLD/plots/violin_plotcnn2.png", width = 800, height = 300,res=125)
print(cnn_vio)
dev.off()
